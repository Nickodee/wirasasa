...
const clientMessages = [
  {
    id: '1',
    name: 'Alice Mwangi',
    preview: 'When will you arrive?',
    time: '08:45',
  },
  {
    id: '2',
    name: 'John Kamau',
    preview: 'Thank you for the service!',
    time: 'Yesterday',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Messages from Clients</Text>
          {clientMessages.map((item) => (
            <TouchableOpacity
              key={item.id}
              style={styles.messageRow}
              onPress={() => navigation.navigate('Chat', { client: { name: item.name, id: item.id } })}
            >
